...
#define MQTT_DEVICES_PWD "77f11dbdb8bf6f9fdafeece813ac2a178d28da2a1f7d09781a6f0e19a740b5fb"

#define HOST_ADDR        "fe9ba280c9.st1.iotda-device.cn-east-3.myhuaweicloud.com"
#define USERNAME         "6836997694a9a05c3361d2fb_intelligent_smarthome"
#define DEVICE_ID        "6836997694a9a05c3361d2fb_intelligent_smarthome_0_0_2025061708"
...
void send_msg_to_mqtt(e_iot_data *iot_data) {
  ...
  if (root != NULL) {
    ...
    cJSON_AddStringToObject(arr_item, "service_id", "Intelligent_Greenhouse");
...
void set_light_state(cJSON *root) {
  ...
  if (status_obj != NULL) {
    ...
    smart_greenhouse_event_send(&event);
  }
}
